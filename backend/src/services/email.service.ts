...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f3f4f6; line-height: 1.6;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f3f4f6; padding: 40px 20px;">
                                ...
                                <tr>
                                    <td>
                                        <div style="display: inline-block; background-color: #0d9488; padding: 10px 12px; border-radius: 8px; margin-bottom: 4px;">
                                            <span style="color: #ffffff; font-size: 20px; font-weight: 700; letter-spacing: -0.5px;">ProcureCorp</span>
                                        </div>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 12px 0 0 0; color: #9ca3af; font-size: 12px; text-align: center;">
                                © ${new Date().getFullYear()} PROCURECORP SYSTEMS INC.
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        const mailOptions = {
            from: process.env.EMAIL_FROM || `"ProcureCorp" <${process.env.EMAIL_USER}>`,
            to: supplierEmail,
...
---
This is an automated notification from ProcureCorp
© ${new Date().getFullYear()} ProcureCorp. All rights reserved.
            `.trim(),
        };
